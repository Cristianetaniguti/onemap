...
There is a GitHub `OneMap` version which is continuously improved, we strongly recommend all users to try [this version](https://github.com/cristianetaniguti/onemap). 
